...
<html lang="en">
  ...
  <head>
    ...
    <title>Rafic's Web Design Portfolio</title>
  ...
  <body>
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top navbar-shrink">
      <div class="container">
        <a class="navbar-brand scroll logo" href="#home">Rafic</a>
   ...
   <header id="home" class="masthead text-center">
       <div class="masthead-content">
         <div class="container">
           <h1 class="masthead-heading">Hello, I'm <span style="color: #007bff">Rafic</span>.</h1>
           <h2 class="masthead-subheading animated rollIn delay-1s">I'm a Web Designer & Developer</h2>
         </div>
       </div>
    </header>
    ...
    <section id="work">
      <div class="container">
        <h2 class="text-center text-uppercase mb-0">Portfolio</h2>
        ...
        <div class="row align-items-center headline">
          <div class="col-lg-6 order-lg-2">
            <a class="portfolio-item d-block mx-auto" href="#portfolio-modal-1">
              ...
              <img class="img-fluid" src="img/studio-21-screenshot.png" alt="">
            </a>
          </div>
          <div class="col-lg-6 order-lg-1">
            <div class="p-5 tagline">
              <h2 class="display-4">Studio 21 <br>Web Design</h2>
        ...
        <div class="row align-items-center headline">
          <div class="col-lg-6">
            <a class="portfolio-item d-block mx-auto" href="#portfolio-modal-2">
              ...
              <img class="img-fluid" src="img/osdbu-screenshot.png" alt="">
            </a>
          </div>
          <div class="col-lg-6">
            <div class="p-5 tagline">
              <h2 class="display-4">Deptartment of Veterans Affairs</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod aliquid, mollitia odio veniam sit iste esse assumenda amet aperiam exercitationem, ea animi blanditiis recusandae! Ratione voluptatum molestiae adipisci, beatae obcaecati.</p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row headline">
          <div class="col-lg-12 text-center">
            <div class="p-4">
            <h2 class="section-heading text-uppercase m-4">Contact</h2>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-3">
              <?=$thankYou ?>
            <form id="contactForm" name="sentMessage" novalidate="novalidate" method="post" action="contact.php">
              <div class="row">
                <div class="col-md-6">
    ...
    <footer class="py-5 bg-black">
      <div class="container">
        <p class="m-0 text-center text-white small">&copy; Rafic Jouejati 2018</p>
      </div>
      <!-- /.container -->
    </footer>
